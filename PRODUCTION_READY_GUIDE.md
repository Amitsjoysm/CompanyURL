...
- Redirect URI: `https://service-restart-auth.preview.emergentagent.com/api/hubspot/callback`
...
HUBSPOT_REDIRECT_URI="https://service-restart-auth.preview.emergentagent.com/api/hubspot/callback"
...
```bash
REACT_APP_BACKEND_URL=https://service-restart-auth.preview.emergentagent.com
```
