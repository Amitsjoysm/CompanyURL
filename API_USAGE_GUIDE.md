...
**Login to get token:**
```bash
curl -X POST https://hubspot-crm-sync.preview.emergentagent.com/api/auth/login \
...
curl -H "X-API-Key: your_api_key" \
  https://hubspot-crm-sync.preview.emergentagent.com/api/crawl/request/req_xyz789
```
...
```bash
curl -H "X-API-Key: your_api_key" \
  "https://hubspot-crm-sync.preview.emergentagent.com/api/crawl/search?query=fintech&limit=20"
```
...
curl -H "Authorization: Bearer jwt_token" \
  https://hubspot-crm-sync.preview.emergentagent.com/api/api-tokens
```
...
curl -X DELETE \
  -H "Authorization: Bearer jwt_token" \
  https://hubspot-crm-sync.preview.emergentagent.com/api/api-tokens/token_123
```
...
curl -X PUT \
  -H "Authorization: Bearer jwt_token" \
  https://hubspot-crm-sync.preview.emergentagent.com/api/api-tokens/token_123/toggle
```
...
```bash
curl -H "X-API-Key: corp_your_key" \
  "https://hubspot-crm-sync.preview.emergentagent.com/api/crawl/search?query=saas&limit=20"
```
