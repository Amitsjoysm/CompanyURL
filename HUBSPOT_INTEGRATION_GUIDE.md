...
```
https://api-access-restore.preview.emergentagent.com/api/hubspot/callback
```
...
- Swagger UI: `https://api-access-restore.preview.emergentagent.com/docs`
- ReDoc: `https://api-access-restore.preview.emergentagent.com/redoc`
